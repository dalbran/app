...
function renderSettingsView() {
  ...
  container.innerHTML = `
    ...
    <section class="mobile-appearance-panel" aria-label="Aparência no celular">
    ...
    <section class="mobile-account-panel" aria-label="Conta conectada">
...
function bindMobileAppearanceControls() {
  const readFontPercent = () => Math.round((parseFloat(document.documentElement.style.fontSize || '16') / 16) * 100);
  const update = () => {
